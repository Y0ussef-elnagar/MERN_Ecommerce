...
const List = () => {
    ...
    return (
        <section className=" relative w-full md:ml-28 min-h-screen bg-linear-to-r from-indigo-900  via-purple-900 to-pink-900 text-white py-24 px-6 sm:px-10">
                    ...
                    {products.map((product) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="bg-red-500 px-4 py-2 rounded-xl text-white font-semibold hover:bg-red-600 transition-all flex items-center justify-center gap-2"
                            >
                                <Trash2 size={18} />
                                حذف
                            </button>
