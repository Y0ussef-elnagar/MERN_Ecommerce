...
const AdminLogin = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-linear-to-r  from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden ">
            ...
            >
                ...
                <button
                    type="submit"
                    className="w-full bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 p-3 rounded-lg font-semibold shadow-lg hover:shadow-pink-500/30 transition-all duration-300 hover:scale-[1.03]"
                >
                    Login
                </button>
            </form>
