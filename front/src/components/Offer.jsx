                            ...
                            <div className="p-5 text-left">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 py-2 rounded-xl font-semibold  hover:opacity-90 transition-all text-white shadow-lg cursor-pointer"
                                    >
