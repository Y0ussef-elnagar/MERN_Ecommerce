...
const Product = () => {
    ...
    if (!product) {
        return (
            <section className=" min-h-screen flex items-center justify-center text-white bg-linear-to-r from-indigo-900  via-purple-900 to-pink-900">
    ...
    const handleAddToCart = () => {
        ...
        alert(
            `✅ تمت إضافة ${quantity} قطعة من ${product.name.slice(0, 25)}... إلى السلة!`,
        );
    };
    ...
    return (
      ...
      py-24 px-6 sm:px-10 flex items-center justify-center"
        >
            <div className="max-w-6xl mx-auto bg-white/10 backdrop-blur-md rounded-3xl p-10 flex flex-col md:flex-row gap-10 shadow-2xl">
                <div className=" md:w-1/2 flex items-center justify-center bg-white/5 rounded-3xl p-6 ">
                    <img
                        src={url + "/images/" + product.image}
                        alt={product.name}
                        className="w-72 sm:w-80 md:w-96 h-auto object-contain rounded-2xl"
                    />
                </div>
                ...
                <div className="flex-1 flex flex-col gap-6">
                    ...
                    <button
                        ...
                        className="w-full md:w-auto bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 px-6 py-3 rounded-2xl font-semibold hover:opacity-90 transition-all text-white shadow-lg"
                    >
                        Add to Cart
                    </button>
                </div>
