...
const Cart = () => {
    ...
    return (
        <section className="relative w-full min-h-screen bg-linear-to-r from-indigo-900 via-purple-900 to-pink-950 text-white py-24 px-6 sm:px-10">
                    ...
                    <>
                        <div className="space-y-6 mb-12 ">
                            {cartProducts.map((item) => (
                                <div
                                    key={item._id}
                                    className="flex flex-col sm:flex-row items-center justify-between bg-white/10  border border-white/20 backdrop-blur-md p-6 rounded-3xl shadow-lg hover:shadow-cyan-400/30 transition-all"
                                >
                        ...
                        <div className="bg-white/10 border border-white/20 backdrop-blur-md p-8 rounded-3xl shadow-xl flex  flex-col sm:flex-row justify-between items-center gap-6 ">
                            ...
                            <button
                                ...
                                className="flex items-center gap-3 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 py-4 px-8 rounded-2xl font-semibold hover:opacity-90 transition-all text-white shadow-lg cursor-pointer"
                            >
